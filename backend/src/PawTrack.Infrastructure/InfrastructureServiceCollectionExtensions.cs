...
public static class InfrastructureServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<ProviderBookingReminderJob>();
        services.AddHostedService<PawTrack.Infrastructure.ServiceProviders.ProviderBookingReminderHostedService>();
        services.AddScoped<ProviderVerificationExpirationJob>();
