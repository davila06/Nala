...
public sealed record ClinicCrmTaskReadModel(
    Guid Id,
    Guid? PetId,
    string? PetName,
    Guid? OwnerUserId,
...
public interface IClinicCrmRepository
{
    ...
    Task<ClinicCrmTask?> GetTaskByIdempotencyKeyAsync(Guid clinicId, Guid idempotencyKey, CancellationToken cancellationToken = default);
