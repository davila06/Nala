...
public sealed record GetCollarStatusQuery(Guid PetId) : IRequest<Result<CollarDto?>>;

public sealed class GetCollarStatusQueryHandler(ICollarRepository collarRepository)
