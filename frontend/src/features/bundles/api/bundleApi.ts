...
> = {
  ...
  QrPlate: {
    label: "Placa QR de aluminio",
    description: "3×5 cm · grabado láser · resistente al agua",
    priceCrc: 4_500,
    emoji: "🔖",
    requiresCollar: false,
  },
  SiliconeTag: {
    label: "Tag de silicona con QR",
    description: "Flexible · colores · impresión UV",
    priceCrc: 5_500,
    emoji: "🏷️",
    requiresCollar: false,
  },
  NfcQrCombo: {
    label: "Combo NFC + QR",
    description: "Toca con Android · escanea con iOS · NTAG213",
    priceCrc: 12_000,
    emoji: "📲",
    requiresCollar: false,
  },
  EmergencyPack: {
    label: "Pack emergencia",
