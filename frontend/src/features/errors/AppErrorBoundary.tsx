      ...
      return (
        <div className="relative flex min-h-screen flex-col items-center justify-center gap-8 overflow-hidden bg-sand-50 px-6 text-center">
          ...
          <div className="relative" aria-hidden="true">
            <div style={{ animation: 'float-bob 4s ease-in-out infinite', fontSize: '5rem' }}>😿</div>
            <span
              style={{
          ...
          <div className="relative z-10 max-w-sm">
            <p className="text-xs font-bold uppercase tracking-[0.3em] text-danger-500">Error inesperado</p>
            <h1 className="mt-2 font-display text-3xl font-bold text-sand-900">Algo salió mal</h1>
            <p className="mt-3 text-sm text-sand-500 leading-relaxed">
              Ocurrió un error al cargar esta pantalla. No te preocupes — tus mascotas están seguras.
