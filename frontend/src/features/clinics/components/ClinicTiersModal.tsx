...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    cta: 'Solicitar Plus',
    ctaHref: 'mailto:alianzas@pawtrack.cr?subject=Solicitar%20Plan%20Cl%C3%ADnica%20Plus',
  },
  {
    id: 'partner',
    ...
    ctaHref: 'mailto:alianzas@pawtrack.cr?subject=Solicitar%20Plan%20Cl%C3%ADnica%20Partner',
  },
]
        ...
        >
          <div className="mb-6 flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-sand-500">Potencia tu clínica y llega a más dueños de mascotas</p>
            </div>
            <button
              type="button"
              onClick={onClose}
