...
export function usePullToRefresh({
  ...
  useEffect(() => {
    ...
    el.addEventListener("touchend", handleTouchEndEvent);

    return () => {
      el.removeEventListener("touchstart", handleTouchStart);
      el.removeEventListener("touchmove", handleTouchMove);
      el.removeEventListener("touchend", handleTouchEndEvent);
    };
  }, [enabled, handleTouchStart, handleTouchMove, handleTouchEndEvent]);
