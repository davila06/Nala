...
describe("PublicPetProfilePage", () => {
  it("displays pet name and lost-state messaging when pet status is Lost", () => {
    mockProfile.mockReturnValue({
      data: LOST_PET,
      isLoading: false,
      isError: false,
    } as ReturnType<typeof usePublicPetProfile>);
    render("/p/pet-1");
  ...
  it("does not show lost-state messaging for Active pet", () => {
    mockProfile.mockReturnValue({
      data: ACTIVE_PET,
      isLoading: false,
      isError: false,
