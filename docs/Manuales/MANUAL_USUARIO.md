...
25. [Cuenta familiar](#25-cuenta-familiar)
26. [Historial médico de tu mascota](#26-historial-médico-de-tu-mascota)
27. [Collar GPS PawTrack](#27-collar-gps-pawtrack)
28. [Planes y suscripciones](#28-planes-y-suscripciones)
29. [Configuración de perfil y preferencias](#29-configuración-de-perfil-y-preferencias)
...
Puedes registrar **tantas mascotas como quieras** en la misma cuenta (los límites dependen de tu plan; ver sección [Planes](#28-planes-y-suscripciones)).
...
El sistema registra cada escaneo con fecha, hora y ubicación aproximada. Puedes ver el **historial de escaneos** en la pestaña QR del perfil de tu mascota para saber cuándo y dónde fue escaneado.

### Avatar de WhatsApp

Para facilitar la difusión, puedes generar una imagen especial con la foto de tu mascota y su código QR superpuesto, optimizada para compartir en WhatsApp. Disponible cuando la mascota está marcada como perdida.
...
- Si sospechas de comportamiento fraudulento de alguien en el chat, usa el botón **Reportar fraude**.

### Reporte de fraude

Si alguien te pide dinero antes de devolverte la mascota, exige algo sospechoso o actúa de forma irregular, toca **Reportar fraude** en el chat. El equipo de PawTrack CR revisará el reporte.
...
Al verificar el código correctamente, el sistema también **marca automáticamente como reclamada** cualquier recompensa (bounty) activa del caso.
...
| **Recordatorio vet**      | Recordatorio de cita veterinaria próxima (plan Familia)                  |
...
1. Ve a **Perfil**.
2. Completa tu perfil de custodio:
...
2. Completa: nombre, número de licencia, dirección, ubicación en el mapa, correo y contraseña.
...
- Escanear el código QR del collar
- Ver si la mascota coincide con un perfil registrado en PawTrack
- Consultar alertas de mascotas perdidas cercanas (plan Clínica Plus y Partner)
...
1. Envía un mensaje al número de WhatsApp de PawTrack CR.
2. El bot te guiará paso a paso: nombre de la mascota, cuándo y dónde la viste, foto.
3. Al completar el flujo, el bot crea el reporte automáticamente y te envía el enlace al perfil público.

El bot **nunca almacena tu número de teléfono**. Solo guarda un hash criptográfico irreversible.
...
Ve a `/estadisticas` (requiere rol Aliado o Admin). Incluye:

- **Tasa de recuperación** por especie, raza y cantón
- **Resumen general**: total de reportes, reunificaciones, tiempo promedio
...
- **Clínicas veterinarias afiliadas** (con logo, teléfono y enlace al sitio web)

Usa los filtros de la barra lateral para ver solo mascotas, solo clínicas, etc.
...
La cuenta familiar te permite que hasta **5 personas** compartan acceso al historial médico de tus mascotas y reciban alertas cuando alguna de ellas sea reportada como perdida.

### Crear una cuenta familiar

1. Ve a **Perfil** → sección **Cuenta familiar**.
2. Escribe el nombre de tu familia (ej. "Familia García").
3. Toca **Crear**.

### Invitar miembros

1. En la sección Cuenta familiar, toca **Invitar**.
2. Ingresa el correo de la persona a invitar.
3. El sistema genera un enlace único. Cópialo y compártelo con la persona.
4. La persona abre el enlace en su navegador. Si no tiene cuenta, será redirigida a `/login` primero.
5. Al aceptar la invitación, queda vinculada a tu cuenta familiar.

> El enlace de invitación tiene la forma `/familia/invitacion/{token}` y es de un solo uso.

### Quitar un miembro

En la sección Cuenta familiar, toca **Quitar** junto al nombre del miembro. Solo el titular (Owner) puede hacer esto.

### Qué comparten los miembros

- Acceso de lectura y escritura al historial médico de **todas** las mascotas del titular.
- Reciben push notifications cuando el titular reporta una mascota como perdida.
- Reciben recordatorios de citas veterinarias.
...
## 27. Collar GPS PawTrack

Si tu mascota usa un collar GPS PawTrack, puedes ver su ubicación en tiempo real.
...
## 29. Configuración de perfil y preferencias
...
- Administrar tu cuenta familiar (plan Familia)
- Ver y gestionar tu suscripción activa
...
No. Cualquier persona puede reportar un avistamiento escaneando el QR de la mascota o desde el mapa público.

**¿Mi dirección o teléfono son visibles para extraños?**  
No. Tu teléfono de contacto solo es visible para rescatistas autenticados. Tu dirección jamás se expone. El chat es completamente enmascarado.

**¿Puedo usar la app en iPhone?**  
Sí. PawTrack CR funciona en Safari (iPhone). Para instalarla: Safari → ícono de compartir → "Agregar a pantalla de inicio".

**¿El código QR funciona sin internet?**  
El código QR es solo una imagen. Quien lo escanea necesita internet para ver el perfil.

**¿Cómo funciona la cuenta familiar?**  
Con el plan Familia, puedes invitar hasta 4 personas más. Todas comparten acceso al historial médico de tus mascotas y reciben alertas cuando alguna se pierde. Las invitaciones se envían por enlace único desde tu perfil.

**¿Qué es el historial médico?**  
Una sección en el perfil de cada mascota (plan Familia) donde puedes registrar vacunas, desparasitaciones, consultas, cirugías y más. Incluye recordatorios de citas y exportación en PDF.

**¿Cómo sé si alguien escaneó el QR de mi mascota?**  
Cada escaneo queda registrado. Ve al perfil de tu mascota → pestaña QR → historial de escaneos.
...
Si ves comportamiento sospechoso en el chat, usa el botón "Reportar fraude". Para problemas técnicos, contacta al equipo de PawTrack CR.
