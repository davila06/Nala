...
| Proveedores externos | `EXTERNAL_PROVIDER_VALIDATION.md`                                            | configuraciones y contratos fuera del repositorio                                         |
...
Los documentos con corte anterior son evidencia histórica, no una declaración
del estado actual, salvo que estén listados como fuente canónica arriba.
